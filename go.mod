...
require (
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20250728091550-15f291aa8ea7 // @grafana/grafana-app-platform-squad
...
require (
	...
	sigs.k8s.io/yaml v1.5.0 // indirect; @grafana-app-platform-squad
)
