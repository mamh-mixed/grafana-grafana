...
require (
	buf.build/gen/go/parca-dev/parca/bufbuild/connect-go v1.10.0-20260312070700-91a25b39bb50.2 // @grafana/observability-traces-and-profiling
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20260323055825-fedbe71e736d // @grafana/grafana-app-platform-squad
	...
	golang.org/x/exp v0.0.0-20251125195548-87e1e737ad39 // @grafana/alerting-backend
