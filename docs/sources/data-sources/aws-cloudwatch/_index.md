...
You can configure the CloudWatch data source by customizing configuration files in Grafana's provisioning system.
...
1. On the CloudWatch data source's configuration page, click the **Dashboards** tab.
1. Click **Import** for the dashboard to import.
