...
require (
	...
	github.com/aws/aws-sdk-go v1.54.19 // @grafana/aws-datasources
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240713175927-c77015b329dc // @grafana/grafana-app-platform-squad
