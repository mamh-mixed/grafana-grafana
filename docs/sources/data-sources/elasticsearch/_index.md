...
You can also override or configure this setting in a dashboard panel under its data source options.
...
For more information about AWS authentication options, refer to [CloudWatch authentication]({{< relref "../aws-cloudwatch/aws-authentication/" >}}).
