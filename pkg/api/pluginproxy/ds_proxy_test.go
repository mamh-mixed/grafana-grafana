...
func TestDataSourceProxy_routeRule(t *testing.T) {
	...
	t.Run("Plugin with routes", func(t *testing.T) {
		...
		t.Run("When matching route path", func(t *testing.T) {
			...
			dsService := datasourceservice.ProvideService(nil, secretsService, secretsStore, cfg, featuremgmt.WithFeatures(), acmock.New(), acmock.NewMockedPermissionsService(), b, quotaService)
