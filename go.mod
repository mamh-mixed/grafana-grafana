...
require (
	...
	github.com/aws/aws-sdk-go v1.54.20 // @grafana/aws-datasources
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240720040231-ee90cd3031b0 // @grafana/grafana-app-platform-squad
