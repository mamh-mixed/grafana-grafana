...
require (
	...
	github.com/aws/aws-sdk-go v1.54.15 // @grafana/aws-datasources
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240705183702-863c9fc34e33 // @grafana/grafana-app-platform-squad
