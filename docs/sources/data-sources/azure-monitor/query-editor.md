...
# Azure Monitor data source query editor

The Azure Monitor data source's query editor has three different modes depending on which Azure service you want to query:
