...
require (
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20250215020800-ea788975e054 // @grafana/grafana-app-platform-squad
...
require (
	...
	github.com/grafana/authlib/types v0.0.0-20250120145936-5f0e28e7a87c // indirect
